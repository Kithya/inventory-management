...
CREATE TABLE "Expenses" (
    ...
    "timestamp" TIMESTAMP(3) NOT NULL,
    "expenseSummaryExpenseSummaryId" TEXT,
...
-- CreateTable
CREATE TABLE "PurchageSummary" (
    "purchaseSummaryId" TEXT NOT NULL,
    "totalPurchased" DOUBLE PRECISION NOT NULL,
    "changePercentage" DOUBLE PRECISION,
    "date" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "PurchageSummary_pkey" PRIMARY KEY ("purchaseSummaryId")
);
...
-- AddForeignKey
ALTER TABLE "Expenses" ADD CONSTRAINT "Expenses_expenseSummaryExpenseSummaryId_fkey" FOREIGN KEY ("expenseSummaryExpenseSummaryId") REFERENCES "ExpenseSummary"("expenseSummaryId") ON DELETE SET NULL ON UPDATE CASCADE;
...
ALTER TABLE "PurchageSummary"
RENAME TO "PurchaseSummary";